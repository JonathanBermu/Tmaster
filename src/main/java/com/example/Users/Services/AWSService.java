...
public class AWSService implements AWSServiceInterface {
    ...
    AWSCredentials credentials = new BasicAWSCredentials("someAWSAccessKey", "someAWSSecretKey");
    ...
    public String addFile(String base64Data, String imgType) throws IOException {
        ...
        s3client.putObject("MyBucketName",  imgName + imgType, fis, metadata);
        return imgName;
    }
    public String getObject(String key) throws IOException {
        try{
            ...
            //Hardcoded return for faster response (develop reason)
